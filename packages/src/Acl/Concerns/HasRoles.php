...
trait HasRoles
{
    ...
    public function roles(): BelongsToMany
    {
        ...
        return $this->belongsToMany(config('acl.models.role', \Tenant\Acl\Role::class))->withTimestamps();
    }
     ...
     *
     * @return \Tenant\Acl\Contracts\Role
     */
    protected function getRoleModel(): Role
    {
        return app()->make(config('acl.models.role', \Tenant\Acl\Role::class));
    }
}
